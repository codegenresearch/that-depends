...
class ResourceContext(typing.Generic[T_co]):
    ...
    @staticmethod
    def is_context_stack_async(context_stack: AsyncExitStack | ExitStack | None) -> typing.TypeGuard[AsyncExitStack]:
        return isinstance(context_stack, AsyncExitStack)

    @staticmethod
    def is_context_stack_sync(context_stack: AsyncExitStack | ExitStack) -> typing.TypeGuard[ExitStack]:
