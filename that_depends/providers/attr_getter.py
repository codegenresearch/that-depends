...
async def _get_value_from_object_by_dotted_path(obj: typing.Any, path: str) -> typing.Any:  # noqa: ANN401
...
class AttrGetter(AbstractProvider[T_co]):
    ...
    async def async_resolve(self) -> T_co:
        ...
        return await _get_value_from_object_by_dotted_path(resolved_provider_object, attribute_path)
