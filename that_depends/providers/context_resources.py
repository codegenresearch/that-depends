...
class ContextResource(AbstractResource[T]):
    ...
    @classmethod
    def create(cls, creator: typing.Callable[P, typing.Iterator[T] | typing.AsyncIterator[T]], *args: P.args, **kwargs: P.kwargs) -> "ContextResource[T]":
    ...
    def _fetch_resource_context(self) -> ResourceContext[T]:
...
class AsyncContextResource(ContextResource[T]):
    @classmethod
    def create(cls, creator: typing.Callable[P, typing.AsyncIterator[T]], *args: P.args, **kwargs: P.kwargs) -> "AsyncContextResource[T]":
        return cls(creator, *args, **kwargs)
