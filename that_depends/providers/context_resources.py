...
from that_depends.providers.resources import sync_container_context
...
class container_context(  # noqa: N801
    ...
    def __exit__(
        ...
        if self._context_token is None:
            raise RuntimeError("Context is not set; ensure __enter__ is called first")
    ...
    async def __aexit__(
        ...
        if self._context_token is None:
            raise RuntimeError("Context is not set; ensure __aenter__ is called first")
